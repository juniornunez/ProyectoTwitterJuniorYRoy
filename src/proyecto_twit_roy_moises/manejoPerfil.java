...
public class manejoPerfil {
    ...
    private static String[][] following = new String[MAX_USUARIOS][MAX_USUARIOS];
    ...
    static {
        for (int i = 0; i < MAX_USUARIOS; i++) {
            numFollowers[i] = 0;
            numFollowing[i] = 0;
            cuentasActivas[i] = true; // Inicialmente, todas las cuentas están activas
        }
    }
    ...
    public static boolean dejarDeSeguirUsuario(String usuarioActual, String usuarioObjetivo) {
        ...
        return false; // No seguía a este usuario
    }
